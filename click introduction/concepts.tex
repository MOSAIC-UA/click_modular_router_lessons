...
\begin{itemize}
	...
	\item Becomes push or pull (inner square/triangle filled or empty)
\end{itemize}
\begin{figure}[t]
	\centering
...
Click mailinglist: \url{https://amsterdam.lcs.mit.edu/mailman/listinfo/click} (Large source of information, mainly for Click developers)
}
