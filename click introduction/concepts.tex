...
\begin{itemize}
	\item Click website: \url{https://github.com/kohler/click}
	\item Element documentation (by name or category)
	\item Programming Concepts
	\item Doxygen documentation ('Internals documentation'): \url{https://student.idlab.uantwerpen.be/click/doxygen}
\end{itemize}
}
\frame{
