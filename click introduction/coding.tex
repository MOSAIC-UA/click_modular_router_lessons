...
\institute{University of Antwerp\\IBBT - PATS Research Group}
\date{October 2011}
...
Let's make an example element: 1 input, 1 output, Push

Configure a packet size threshold, larger: drop packet

Download the source code online to avoid copy errors at \url{http://www.pats.ua.ac.be/software/click}
}
